...
export const QUESTIONS = [
  ...
  },
  {
    ...
    learnMore: "Post-departure IP rights are where partnerships often break down. Consider: if one partner created a signature dish that built the business's reputation, should the other partner be able to use that exact recipe at a competing booth? California law (Business & Professions Code §16600) prohibits non-compete clauses, meaning you <strong>cannot</strong> prevent an ex-partner from opening a competing food business — but you <strong>can</strong> restrict their use of specific recipes and trade secrets through IP provisions. The operating agreement should specify: Does the business retain any rights to the recipes? Can the departing creator use them immediately or is there a cooling-off period? What about recipes developed jointly during the partnership? These questions should be answered before formation, not during a contentious breakup.",
    options: [
